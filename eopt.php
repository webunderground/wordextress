...
<p>Description<textarea type="text" rows="10" id="textarea2" style="width: 99%;"  value="<?php echo $row->description;?>" name="description"><?php echo $row->description;?></textarea></p>
